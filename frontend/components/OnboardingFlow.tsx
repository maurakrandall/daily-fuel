...
export default function OnboardingFlow({ userName, onComplete }: OnboardingFlowProps) {
  ...
  const SunArcPicker = () => {
    ...
    return (
      <div className="flex flex-col items-center w-full max-w-[280px] mx-auto">
        ...
        <div 
          ref={arcRef}
          className="relative w-[200px] h-[100px] mb-6 cursor-pointer touch-none"
        ...
        <div className="flex items-baseline gap-2 mb-6 mt-2">
          <span className="text-5xl font-serif text-[#0A192F] tracking-tight">{displayTime.time}</span>
          <span className="text-xl font-serif text-[#0A192F]/40">{displayTime.ampm}</span>
        </div>
        ...
        <div className="relative">
          <input
            ...
            className="bg-white border border-[#0A192F]/10 rounded-full py-2.5 pl-5 pr-10 text-[#0A192F] font-medium focus:outline-none focus:border-[#D4AF37]/50 focus:ring-1 focus:ring-[#D4AF37]/50 transition-all shadow-sm appearance-none text-sm"
            style={{ WebkitAppearance: 'none' }}
          />
          <Clock className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#0A192F]/40 pointer-events-none" />
        </div>
      </div>
    );
  };
  ...
  return (
    <div className="flex-1 flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col justify-center overflow-y-auto py-4">
        ...
        {step === 1 && (
          <div className="space-y-6 animate-in slide-in-from-bottom-4 fade-in duration-500 text-center">
            ...
            <div className="space-y-4">
              <h2 className="text-3xl font-serif text-[#0A192F] tracking-tight">
                Welcome to <span className="italic font-serif">Daily Fuel.</span>
              </h2>
            ...
            <div className="pt-2">
              ...
              >
                <div className={`w-5 h-5 rounded border flex items-center justify-center mr-3 transition-colors ${
                  ...
                  {medicalConfirmed && <Check className="w-3 h-3 text-white stroke-[3]" />}
                </div>
                <span className="text-[#0A192F] font-medium text-sm">I confirm I am under medical care.</span>
              </button>
            </div>
          </div>
        )}
        ...
        {step === 2 && (
          <div className="space-y-6 animate-in slide-in-from-bottom-4 fade-in duration-500 text-center">
            ...
            <div className="space-y-4">
              <h2 className="text-3xl font-serif text-[#0A192F] tracking-tight">
                Your data stays <span className="italic font-serif">yours.</span>
              </h2>
              <p className="text-[#0A192F]/80 text-base leading-relaxed max-w-sm mx-auto">
            ...
            <div className="bg-white/40 border border-[#0A192F]/5 rounded-2xl p-5 text-left space-y-3 mt-4">
              <div className="flex items-center">
                <div className="w-4 h-4 rounded-full border border-[#D4AF37] flex items-center justify-center mr-3 flex-shrink-0">
                  <Check className="w-2.5 h-2.5 text-[#D4AF37] stroke-[3]" />
                </div>
                <span className="text-[#0A192F]/80 font-medium text-sm">No sale of your information</span>
              </div>
              <div className="flex items-center">
                <div className="w-4 h-4 rounded-full border border-[#D4AF37] flex items-center justify-center mr-3 flex-shrink-0">
                  <Check className="w-2.5 h-2.5 text-[#D4AF37] stroke-[3]" />
                </div>
                <span className="text-[#0A192F]/80 font-medium text-sm">No sharing with insurers or employers</span>
              </div>
              <div className="flex items-center">
                <div className="w-4 h-4 rounded-full border border-[#D4AF37] flex items-center justify-center mr-3 flex-shrink-0">
                  <Check className="w-2.5 h-2.5 text-[#D4AF37] stroke-[3]" />
                </div>
                <span className="text-[#0A192F]/80 font-medium text-sm">No advertising profile, ever</span>
              </div>
            </div>

            <div className="pt-2">
              <button className="text-xs text-[#D4AF37] font-medium hover:text-[#D4AF37]/80 transition-colors underline underline-offset-4 decoration-[#D4AF37]/30">
        ...
        {step === 3 && (
          <div className="space-y-6 animate-in slide-in-from-bottom-4 fade-in duration-500 text-left">
            <div className="space-y-3">
              <div className="text-[10px] font-bold text-[#D4AF37] uppercase tracking-widest">About You</div>
              <h2 className="text-3xl font-serif text-[#0A192F] tracking-tight leading-tight">
                Did your <span className="italic font-serif">provider</span> share daily protein or fiber targets with you?
              </h2>
            ...
            {hasTargets === 'yes' && (
              <div className="space-y-6 pt-2 animate-in fade-in duration-500">
                <div className="space-y-3">
                  <h3 className="text-[10px] font-bold text-[#0A192F]/40 uppercase tracking-widest">Protein Target · Grams/Day</h3>
                  <div className="flex flex-wrap gap-2">
                    ...
                    <button className="px-4 py-2 rounded-full text-sm font-medium border border-dashed border-[#0A192F]/30 text-[#0A192F]/50 bg-transparent hover:bg-[#0A192F]/5 transition-colors">
                      Custom
                    </button>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <h3 className="text-[10px] font-bold text-[#0A192F]/40 uppercase tracking-widest">Fiber Target · Grams/Day</h3>
                  <div className="flex flex-wrap gap-2">
                    {['25g', '30g', '35g'].map(val => (
                      <button
                        key={val}
                ...
                {(proteinTarget || fiberTarget) && (
                  <div className="bg-[#D4AF37]/10 border border-[#D4AF37]/20 rounded-xl p-3 flex items-start gap-2 animate-in fade-in duration-500">
                    <Sun className="w-4 h-4 text-[#D4AF37] flex-shrink-0 mt-0.5" />
                    <p className="text-[#0A192F]/80 text-xs leading-relaxed">
                      <span className="italic font-serif">Perfect — we'll use those to help you close the gap.</span>
                    </p>
                  </div>
                )}
              </div>
        ...
        {step === 4 && (
          <div className="space-y-6 animate-in slide-in-from-bottom-4 fade-in duration-500 text-left">
            <div className="space-y-3">
              <div className="text-[10px] font-bold text-[#D4AF37] uppercase tracking-widest">Your Kit</div>
              <h2 className="text-3xl font-serif text-[#0A192F] tracking-tight leading-tight">
                My <span className="italic font-serif">Go-Tos.</span>
              </h2>
              <p className="text-[#0A192F]/80 text-base leading-relaxed">
            ...
            {selectedGoTos.size > 0 && (
              <div className="bg-[#D4AF37]/10 border border-[#D4AF37]/20 rounded-xl p-3 flex items-center gap-2 animate-in fade-in duration-500 mt-4">
                <Sun className="w-4 h-4 text-[#D4AF37] flex-shrink-0" />
                <p className="text-[#0A192F]/80 text-xs">
        ...
        {step === 5 && (
          <div className="space-y-6 animate-in slide-in-from-bottom-4 fade-in duration-500 text-left">
            <div className="space-y-3">
              <div className="text-[10px] font-bold text-[#D4AF37] uppercase tracking-widest">Your Kit</div>
              <h2 className="text-3xl font-serif text-[#0A192F] tracking-tight leading-tight">
                Will eat. <span className="italic font-serif text-[#0A192F]/40">Won't eat.</span>
              </h2>
              <p className="text-[#0A192F]/80 text-base leading-relaxed">
            ...
            <div className="space-y-6 pt-2">
              {WILL_EAT_CATEGORIES.map(category => (
                <div key={category.name} className="space-y-3">
                  <h3 className="text-[10px] font-bold text-[#0A192F]/40 uppercase tracking-widest">
                    {category.name}
                  </h3>
                  <div className="flex flex-wrap gap-2">
        ...
        {step === 6 && (
          <div className="space-y-8 animate-in slide-in-from-bottom-4 fade-in duration-500 text-center">
            ...
            <div className="space-y-4">
              <h2 className="text-3xl font-serif text-[#0A192F] tracking-tight">
                Current <span className="italic font-serif">Weight</span>
              </h2>
              <p className="text-[#0A192F]/80 text-base leading-relaxed max-w-sm mx-auto">
                Your current weight helps us personalize your protein target. Add it now or anytime later.
              </p>
              <div className="relative max-w-[160px] mx-auto pt-2">
                <input
                  type="number"
                  value={currentWeight}
                  onChange={(e) => setCurrentWeight(e.target.value)}
                  placeholder="0"
                  className="w-full bg-transparent border-b-2 border-[#0A192F]/20 px-2 py-3 text-3xl text-center text-[#0A192F] focus:outline-none focus:border-[#D4AF37] transition-all"
                />
                <span className="absolute right-2 top-1/2 -translate-y-1/2 text-[#0A192F]/40 text-lg">lbs</span>
              </div>
            </div>

            <div className="space-y-4 pt-6 border-t border-[#0A192F]/10">
              <h2 className="text-3xl font-serif text-[#0A192F] tracking-tight">
                Goal <span className="italic font-serif">Weight</span>
              </h2>
              <p className="text-[#0A192F]/80 text-base leading-relaxed max-w-sm mx-auto">
        ...
        {step === 7 && (
          <div className="space-y-6 animate-in slide-in-from-bottom-4 fade-in duration-500 text-center">
            ...
            <div className="space-y-4">
              <h2 className="text-3xl font-serif text-[#0A192F] tracking-tight">
                Shot <span className="italic font-serif">Day</span>
              </h2>
              <p className="text-[#0A192F]/80 text-base leading-relaxed max-w-sm mx-auto">
            ...
            <div className="grid grid-cols-2 gap-2 pt-2">
              {DAYS.map(day => (
                <button
                  ...
                  className={`py-3 rounded-2xl text-base font-medium transition-all duration-300 ${
                    shotDay === day
        ...
        {step === 8 && (
          <div className="space-y-6 animate-in slide-in-from-bottom-4 fade-in duration-500 text-center">
            ...
            <div className="space-y-4">
              <h2 className="text-3xl font-serif text-[#0A192F] tracking-tight">
                Your <span className="italic font-serif">Supplements</span>
              </h2>
              <p className="text-[#0A192F]/80 text-base leading-relaxed max-w-sm mx-auto">
            ...
            <div className="space-y-6 pt-2">
              <div className="space-y-3">
                <h3 className="text-[10px] font-bold text-[#0A192F]/40 uppercase tracking-widest">Tier 1</h3>
              ...
              <div className="space-y-3">
                <h3 className="text-[10px] font-bold text-[#0A192F]/40 uppercase tracking-widest">Tier 2</h3>
                <div className="flex flex-wrap justify-center gap-2">
        ...
        {step === 9 && (
          <div className="space-y-6 animate-in slide-in-from-bottom-4 fade-in duration-500 text-left">
            <div className="space-y-3">
              <div className="text-[10px] font-bold text-[#D4AF37] uppercase tracking-widest">YOUR RHYTHM</div>
              <h2 className="text-3xl font-serif text-[#0A192F] tracking-tight leading-tight">
                When should we <span className="italic font-serif">check in?</span>
              </h2>
              <p className="text-[#0A192F]/80 text-base leading-relaxed">
        ...
        {step === 10 && (
          <>
            <div className="absolute inset-0 bg-gradient-to-b from-[#FDFBF7] to-[#F4D780]/50 -z-10 pointer-events-none rounded-[2rem]" />
            <div className="space-y-6 animate-in slide-in-from-bottom-4 fade-in duration-500 text-center pt-4">
              <div className="flex justify-center mb-8 relative">
                <div className="w-24 h-24 bg-gradient-to-b from-[#F4D780] to-[#D4AF37] rounded-full shadow-[0_0_60px_rgba(212,175,55,0.5)] relative z-10"></div>
                {/* Large rays */}
                <div className="absolute top-[-12px] left-1/2 -translate-x-1/2 w-1 h-4 bg-[#D4AF37]/40 rounded-full"></div>
                <div className="absolute bottom-[-12px] left-1/2 -translate-x-1/2 w-1 h-4 bg-[#D4AF37]/40 rounded-full"></div>
                <div className="absolute left-[-12px] top-1/2 -translate-y-1/2 w-4 h-1 bg-[#D4AF37]/40 rounded-full"></div>
                <div className="absolute right-[-12px] top-1/2 -translate-y-1/2 w-4 h-1 bg-[#D4AF37]/40 rounded-full"></div>
                <div className="absolute top-[-6px] left-[-6px] w-3 h-1 bg-[#D4AF37]/40 rounded-full rotate-45 origin-bottom-right"></div>
                <div className="absolute top-[-6px] right-[-6px] w-3 h-1 bg-[#D4AF37]/40 rounded-full -rotate-45 origin-bottom-left"></div>
                <div className="absolute bottom-[-6px] left-[-6px] w-3 h-1 bg-[#D4AF37]/40 rounded-full -rotate-45 origin-top-right"></div>
                <div className="absolute bottom-[-6px] right-[-6px] w-3 h-1 bg-[#D4AF37]/40 rounded-full rotate-45 origin-top-left"></div>
              </div>
              
              <div className="space-y-4">
                <div className="text-[10px] font-bold text-[#D4AF37] uppercase tracking-widest">YOU'RE SET</div>
                <h2 className="text-3xl font-serif text-[#0A192F] tracking-tight">
                  Welcome in, <span className="italic font-serif">{userName}.</span>
                </h2>
                
                <div className="bg-white/60 backdrop-blur-md border border-[#0A192F]/10 rounded-2xl p-5 text-left space-y-3 mt-6 shadow-sm">
                  <p className="text-[#0A192F]/80 text-base leading-relaxed">
                    {selectedGoTos.size > 0 
                      ? `You've got ${Array.from(selectedGoTos).slice(0, 3).join(', ')}${selectedGoTos.size > 3 ? ', and more' : ''} in your corner.`
                      : "Your profile is ready to go."}
                  </p>
                  <div className="h-px w-full bg-[#0A192F]/10"></div>
                  <p className="text-[#0A192F]/80 text-base leading-relaxed">
      ...
      {/* Fixed Bottom Navigation inside the card */}
      <div className="flex-none pt-4 mt-auto">
        <div className="flex flex-col gap-2">
          <button
            onClick={nextStep}
            disabled={(step === 1 && !medicalConfirmed) || (step === 3 && hasTargets === null)}
            className="w-full py-3.5 rounded-full bg-[#0A192F] text-white font-medium hover:bg-[#0A192F]/90 transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-[#0A192F]/10 text-base"
          >
